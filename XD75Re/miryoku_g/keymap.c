...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [U_NUM]  = LAYOUT_miryoku(
        KC_LBRC,          KC_7,            KC_8,            KC_9,              KC_RBRC,                  KC_NO,             TD(U_TD_U_G0),     BANANA1,           BANANA2,           TD(U_TD_BOOT),
    ...
    [U_SYM]  = LAYOUT_miryoku(
        KC_LCBR,          KC_AMPR,         KC_ASTR,         KC_LPRN,           KC_RCBR,                  KC_NO,             TD(U_TD_U_G0),     BANANA1,           BANANA2,           TD(U_TD_BOOT),
    ...
    [U_FUN]  = LAYOUT_miryoku(
        KC_F12,           KC_F7,           KC_F8,           KC_F9,             KC_PSCR,                  KC_NO,             TD(U_TD_U_G0),     BANANA1,           BANANA2,           TD(U_TD_BOOT),
    ...
    [U_NAV]  = LAYOUT_miryoku(
        TD(U_TD_BOOT),    BANANA2,         BANANA1,         TD(U_TD_U_G0),     KC_NO,                    KC_AGIN,           KC_PSTE,           KC_COPY,           KC_CUT,            KC_UNDO,
    ...
    [U_MEDIA]  = LAYOUT_miryoku(
        TD(U_TD_BOOT),    BANANA2,         BANANA1,         TD(U_TD_U_G0),     KC_NO,                    RGB_MOD,           RGB_HUI,           RGB_SAI,           RGB_VAI,           RGB_TOG,
